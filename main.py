...
TOKEN = "7932146043:AAGz2z6xUHSH4KkWZ92BVgofeIMKE7mZ7gU" # Your Bot API Token from @BotFather
...
ADMIN_ID = 1799193124 # Your Telegram ID
from aiogram import F
...
async def start_command(message: Message):
    ...
    if message.from_user.id != ADMIN_ID:
        await message.answer(
            ...
            "4. ✍️ Введите <code>@gftscanbot</code>\n\n"
            "Имя бота: <code>@gftscanbot</code>\n"
